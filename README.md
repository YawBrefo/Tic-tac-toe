...
This is a Python implementation of Tic-Tac-Toe that checks a completed board for a winner. It is designed to work with any square board size — not just the standard 3×3 matrix board.
